...
function provinsi(graf, filter){
    let arr = [
        ...
        [32, 33, 101], [33, 34, 212], [33, 42, 119], [34, 40, 68], [35, 36, 191], [35, 53, 198], [36, 37, 134], [36, 41, 60], [37, 61, 302], [39, 40, 23], 
        [40, 45, 39], [42, 43, 76], [42, 47, 91], [43, 44, 88], [43, 48, 92], [44, 51, 124], [45, 50, 71], [46, 47, 69], [48, 62, 95], [49, 50, 33], 
        [50, 52, 68], [52, 63, 63], [53, 54, 31], [53, 62, 180], [54, 55, 233], [54, 58, 13], [55, 56, 28], [55, 59, 52], [56, 57, 30], [57, 60, 54],
    ...
    for(let i = 0; i < arr.length; i++){
        graf[arr[i][0]].push([arr[i][1], arr[i][2]]);
        graf[arr[i][1]].push([arr[i][0], arr[i][2]]);
    }
...
function djikstra(jumlahTitik, titikAwal, graf){
    ...
    while(antrian.length != 0){
        ...
        for(const tetangga of graf[titikSekarang]){
